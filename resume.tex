...
\begin{flushleft}
    ...
    \newline
    \newline
Passionate Software developer with 2+ years of experience with ReactJs, Django Rest Framework, NodeJs, and other web technologies. Strong in creative and analytical skills.
    \newline
\end{flushleft}
...
\begin{tabularx}{\textwidth}{X r}
    \large{\textbf{3.) Str8bat}} & Banglore, India\\
    \textit{Software Developer} & \textit {Sept, 2020 - Present}\\
\end{tabularx}
\begin{itemize}
    \textbf{Responsibilites:}
    Development and Deoplyment of backend APIs for the Str8bat Unity App,
    \href{https://getbetter.str8bat.com}{getbetter.str8bat.com} (A platform for purchasing ticket for live session with professional cricketers)
    \newline
...
\newline
\textbf{Tech}: PHP, Wordpress, HTML, CSS, JavaScript, Jquery, LESS, SASS.
\newline
